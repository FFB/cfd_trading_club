package cfd_trading_club::Schema::Result::UserRole;
...
Related object: L<cfd_trading_club::Schema::Result::Role>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:w4SI4ZkpLIU93BtWiSoZVQ
